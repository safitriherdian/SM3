    ...
    <div class="row">
      <div class="col-md-12">
        <div class="sm3-card">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <div class="db-flex" style="column-gap: 0px;">
                <input type="text" class="form-control" id="usr1" name="title" value="{{old("date",$data->date)}}">
          ...
          <div class="form-group row">
            ...
            <div class="db-flex">
              <div class="form-group col-sm-6">
                <div class="db-flex" style="column-gap: 0px;">
                  <input type="text" class="form-control" id="timepkr" onclick="showpickers('timepkr',24)" name="title" value="{{old("time_start",$data->getTimeStart())}}">
              ...
              <div class="form-group col-sm-6">
                <div class="db-flex" style="column-gap: 0px;">
                  <input type="text" class="form-control" id="timepkr2" onclick="showpickers('timepkr2',24)" name="title" value="{{old("time_end",$data->getTimeEnd())}}">
                  <button type="button" class="input-group-addon span-icon"><i class="fa fa-clock"></i></span>
                </div>
                @if($errors->has('time_start'))
                <p class="alert-danger">{{$errors->first('time_start')}}</p>
          ...
          <button href="" class="btn btn-warning btn-kanan" role="button" aria-disabled="true">Kembali</button>
          <br><br>
